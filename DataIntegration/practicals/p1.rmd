...
To remind you, Jean-Karim has provided us with several graph kernels that measure the similarity between human genes according to information derived from 5 sources. These sources include:
...
The genes in the similarity matrices (rows and columns) are derived from similarities between 120 genes that were selected 

- chromosome condensation
- DNA mismatch repair (KEGG:hsa03430)
- mitotic spindle checkpoint
- endocytosis (GO:0006897)
- signalling by BMP

`r length(unique(c(data$gene1,data$gene2)))`
